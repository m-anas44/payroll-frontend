...
export function WorkerHeader({ setMobileOpen }: WorkerHeaderProps) {
  ...
  const notifications = [
    {
      id: "1",
      title: "Daily Production Synced",
      desc: "Your logged production entries have been recorded for piece-rate calculations.",
      time: "Today",
      icon: CheckCircle2,
              ...
              <div className="space-y-2 max-h-72 overflow-y-auto">
                {notifications.map((n) => {
                  ...
                  return (
                    <div
                      key={n.id}
                      className="p-2.5 rounded-xl bg-slate-50 border border-slate-100 flex gap-2.5 items-start"
                    >
